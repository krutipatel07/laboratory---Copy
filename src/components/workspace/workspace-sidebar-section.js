...
import { WorkspaceSidebarItem as WorkspaceSidebarItem } from './workspace-sidebar-item';
...
export const WorkspaceSidebarSection = (props) => {
...
WorkspaceSidebarSection.propTypes = {
